...
const CourseOrderPayment = ({ handleChange, selectedPayment, disabled }) => {
  const _onChange = (e) => {
    ...
    <div className="itemorder paymentorder">
      ...
      <div className="boxorder">
        {PAYMENTS.map((payment) => {
          ...
          return (
            <div key={id} className="boxorder__pay">
              <label className="radiocontainer">
                <img src={icon} alt={label} />
                {label}
                <input type="radio" name="radio" value={id} onChange={_onChange} disabled={disabled}/>
...
export default CourseOrderPayment;
